# -*- coding: utf-8 -*-
#
# PRISEM utilities documentation build configuration file, created by
# sphinx-quickstart on Mon Dec 29 20:15:42 2014.
#
...
project = u'PRISEM utilities'
copyright = u'2014, David Dittrich'
...
htmlhelp_basename = 'PRISEMutilitiesdoc'
...
latex_documents = [
  ('index', 'PRISEMutilities.tex', u'PRISEM utilities Documentation',
...
man_pages = [
    ('index', 'prisemutilities', u'PRISEM utilities Documentation',
     [u'David Dittrich'], 1)
]
...
texinfo_documents = [
  ('index', 'PRISEMutilities', u'PRISEM utilities Documentation',
   u'David Dittrich', 'PRISEMutilities', 'One line description of project.',
   'Miscellaneous'),
]
